...
mmap.style = "width: 400px; height: 400px; display: none; position: relative; margin-top: -10%; margin-bottom: 20%;"
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    modifyButton.onclick = function (response) {
                        ...
                        coordButton.onclick = function (response) {
                            ...
                            latDisplayDiv.style = "display: flex; flex-direction: row; align-items: center; justify-content: center;"
                            ...
                            longDisplayDiv.style = "display: flex; flex-direction: row; align-items: center; justify-content: center;"
                        ...
                        notifDiv.style = "display: flex; flex-direction: row; align-items: center; justify-content: center;"
                        ...
                        submit.onclick = async function (event) {
                            ...
                            let latitude
                            let longitude
                            if (document.getElementById("lat-display-val") === null) // elementul asta s-ar putea sa nu fie creat
                            {
                                latitude = latitude
                            }

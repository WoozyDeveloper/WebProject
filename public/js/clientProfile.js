...
function accountInfo() {
    ...
    username.style = "display: flex; flex-direction: column; align-items: flex-end; justify-content: center;"
    ...
    mail.style = "display: flex; flex-direction: column; align-items: flex-end; justify-content: flex-start;"
    ...
    password.style = "display: flex; flex-direction: column; align-items: flex-end; justify-content: flex-start;"
    ...
    useridText.style = "display: flex; flex-direction: column; align-items: flex-end; justify-content: flex-start;"
...
function preferences() {
    ...
    locations.style = "display: flex; flex-direction: column; align-items: flex-start; justify-content: center;"
        ...
        (fetch(`http://localhost:4002/?table=UserPreferences&userid=${userid}`)
            ...
            .then((data) => {
                for (let i = 0; i < data.length; i++) {
                    ...
                    locationDiv.style = "display: flex; flex-direction: column; align-items: flex-start; justify-content: center;"
                    ...
                    {
                        let currentIndex = Array.from(locations.children).indexOf(locationDiv)
                        ...
                        locationInputDiv.style = "display: flex; flex-direction: row; align-items: center; justify-content: center;"
                        ...
                        eventtypeInputDiv.style = "display: flex; flex-direction: row; align-items: center; justify-content: center;"
                        ...
                        coordDiv.style = "display: flex; flex-direction: row; align-items: center; justify-content: center;"
                        ...
                        locations.insertBefore(locationNr,locations.children[currentIndex]) //insereaza nr locatiei
